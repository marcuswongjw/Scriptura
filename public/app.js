...
import { auth } from './js/firebase.js?v=2.0.17';
...
import { debounce } from './js/utils.js?v=2.0.17';
import { showToast } from './js/toast.js?v=2.0.17';
import { el } from './js/dom.js?v=2.0.17';
import { state } from './js/state.js?v=2.0.17';
import { handlePublisherFileInput, handlePublisherSubmit, handleTemplateToggle, wireVisualEditor } from './js/admin.js?v=2.0.17';
import { handleGoogleSignIn, handleLoginSubmit, handleRegisterSubmit, switchAuthTab } from './js/auth_ui.js?v=2.0.17';
import { renderCoursesCatalog, updateFilterTagsUI } from './js/catalog.js?v=2.0.17';
import { renderDashboard } from './js/dashboard.js?v=2.0.17';
import { closeLesson, handleNextClick, handlePrevClick, renderSlide, startModule } from './js/lesson.js?v=2.0.17';
import { handleProfileSave, initNetworkViewer, openProfileDialog, setupPhotoUpload } from './js/network.js?v=2.0.17';
import { checkAndSyncPushToken, registerServiceWorker } from './js/push.js?v=2.0.17';
import { routeToPath, switchDashboardSubtab, switchTab } from './js/routing.js?v=2.0.17';
import { updateStatsDisplay } from './js/stats.js?v=2.0.17';
import { checkAdminNavVisibility, fetchAndMergeCustomModules, loadModuleSchedules, loadUserCloudData, resetLocalState, saveState, updateHeaderProfile, updateStreak } from './js/user.js?v=2.0.17';
import { wireOnboarding, maybeShowOnboarding } from './js/onboarding.js?v=2.0.17';
import { maybeSendDailyReadingReminder, surfaceUnreadNotifications } from './js/notifications.js?v=2.0.17';
